...
df_aliadas_team2 = pd.read_csv("/content/Aliadas_team2.csv", encoding = "latin1")
...
display(results_smote_presplit_df)
...
display(results_smote_postsplit_df)
...
display(total_loans_by_client_type)
...
display(loans_per_entity_filtered_8.head()) # Muestra las primeras filas
